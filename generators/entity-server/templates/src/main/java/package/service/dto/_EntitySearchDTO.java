...
<%= entityClass %>SearchDTO <%= entityInstance %>SearchDTO = (<%= entityClass %>SearchDTO) o;
    if(<%= entityInstance %>SearchDTO.getId() == null || getId() == null) {
    return false;
    }
    return Objects.equals(getId(), <%= entityInstance %>SearchDTO.getId());
    }
