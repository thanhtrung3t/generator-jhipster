...
@Injectable()
export class <%= entityAngularName %>DetailPopupService {
    ...
    open(component: Component, id?: number | any , <%=parentRelationshipName%>Id?: number | any  ): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    let entity = new <%= entityAngularName %>();
                    entity.<%=parentRelationshipName%>Id =  <%=parentRelationshipName%>Id;
                    this.ngbModalRef = this.<%= entityInstance %>ModalRef(component, entity);
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
